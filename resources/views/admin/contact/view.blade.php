													...
													<div class="row">
														<div class="col-md-12">
															<div class="address_info">
																<div class="right-edit-btn"> <a href="#" data-toggle="modal" data-target="#edit-address"><i class="ft-edit"></i></a>
																</div>
																<ul class="col_bx">
																	<li>
																	...
																	<li>
																		...
																		<div class="address-data"> <a href="#">+44 (10) 747998 2435</a>
																		</div>
																	</li>
																	<li>
																		<div class="icons"> <i class="ft-edit"></i>
																		</div>
																		<div class="address-data"> <a href="#">+44 (10) 1707 562 487</a>
																		</div>
																	</li>
																</ul>
															</div>
													...
													<div class="row">
																...
																<div class="tab-pane fade show active" id="tab0" role="tabpanel" aria-labelledby="tab">
																	<div class="address_info">
																		<div class="right-edit-btn">
																			<a href="#" data-toggle="modal" data-target="#edit-address">	<i class="ft-edit"></i>
																			</a>
																		</div>
																		<ul class="col_bx">
																			<li>
														...
														<div class="col-md-4">
															<ul class="nav nav-tabs address_info" id="myTab" role="tablist">
																...
																<li class="nav-item" role="presentation"> <a class="active" id="tab" data-toggle="tab" href="#tab0" role="tab" aria-controls="tab0" aria-selected="true"><span> <i class="ft-edit"></i></span>Correspondence</a>
																</li>
																<li class="nav-item" role="presentation"> <a class="active" id="tab-one" data-toggle="tab" href="#tab1" role="tab" aria-controls="tab1" aria-selected="false"><span> <i class="ft-edit"></i></span>Invoice/Billing</a>
																</li>
																<li class="nav-item" role="presentation"> <a class="" id="tab-tow" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"><span> <i class="ft-edit"></i></span>Registered address </a>
																</li>
																<li class="nav-item" role="presentation"> <a class="" id="tab-three" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false"><span> <i class="ft-edit"></i></span>Shipping<span class="shiping-icon"><i class="ft-edit"></i></span></a>
																</li>
																<li class="nav-item" role="presentation"> <a class="" id="tab-four" data-toggle="tab" href="#tab4" role="tab" aria-controls="tab4" aria-selected="false"><span> <i class="ft-edit"></i></span>Other Address</a>
																</li>
															</ul>
														</div>
													</div>
