            ...
            <div class="breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper mr-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Relationship</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                <p class="card-text"><a href="{{route('create-view.relationship')}}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($relationship->status === 'active')
                                                        <span style="color:green"> {{$relationship->status}}</span>
                                                    @else
                                                        <span style="color:blue"> {{$relationship->status}}</span>
                                                    @endif

                                                </td>
                                                <td>{{$relationship->created_at->diffForHumans()}}</td>
                                                <td>
                                                    <span class="dropdown">
                                                    ...
                                                    @if($relationship->status === 'active')
                                                            <a href="{{route('inactive.relationship' , encrypt($relationship->id))}}" class="dropdown-item" title="click to make inactive the active value">
                                                                <i class="ft-plus-circle primary"></i> Inactive</a>
                                                    @else
                                                            <a href="{{route('active.relationship' ,  encrypt($relationship->id))}}" class="dropdown-item" title="click to make active the inactive value">
                                                                <i class="ft-plus-circle primary"></i> Active</a>
                                                    @endif
                                                            <a href="{{route('update.relationship' ,  encrypt($relationship->id))}}" class="dropdown-item" title="Edit the value">
                                                                <i class="ft-trash-2"></i> Edit</a>
                                                            <a href="{{route('delete.relationship' ,  encrypt($relationship->id))}}" class="dropdown-item" title="Danger! this action will delete the record from database">
