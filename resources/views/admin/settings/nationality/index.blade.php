            ...
            <div class="breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper mr-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Nationality</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                <p class="card-text"><a href="{{route('create-view.nationality')}}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($nationality->status === 'active')
                                                        <span style="color:green"> {{$nationality->status}}</span>
                                                    @else
                                                        <span style="color:blue"> {{$nationality->status}}</span>
                                                    @endif
                                                ...
                                                <td>
                                                    ...
                                                    @if($nationality->status === 'active')
                                                            <a href="{{route('inactive.nationality' , encrypt($nationality->id))}}" class="dropdown-item" title="click to make inactive the active value">
                                                                <i class="ft-plus-circle primary"></i> Inactive</a>
                                                    @else
                                                            <a href="{{route('active.nationality' ,  encrypt($nationality->id))}}" class="dropdown-item" title="click to make active the inactive value">
                                                                <i class="ft-plus-circle primary"></i> Active</a>
                                                    @endif
                                                            <a href="{{route('update.nationality' ,  encrypt($nationality->id))}}" class="dropdown-item" title="Edit the value">
                                                                <i class="ft-trash-2"></i> Edit</a>
                                                            <a href="{{route('delete.nationality' ,  encrypt($nationality->id))}}" class="dropdown-item" title="Danger! this action will delete the record from database">
