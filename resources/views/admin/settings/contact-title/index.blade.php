                                        ...
                                        @foreach($contactTitles as $contactTitle)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($contactTitle->status === 'active')
                                                            <a href="{{route('inactive-contact-title' , encrypt($contactTitle->id))}}" class="dropdown-item" title="click to make inactive the active value">
                                                                <i class="ft-plus-circle primary"></i> Inactive</a>
                                                    @else
                                                            <a href="{{route('active-contact-title' ,  encrypt($contactTitle->id))}}" class="dropdown-item" title="click to make active the inactive value">
                                                                <i class="ft-plus-circle primary"></i> Active</a>
                                                    @endif
                                                            <a href="{{route('update-contact-title' ,  encrypt($contactTitle->id))}}" class="dropdown-item" title="Edit the value">
                                                                <i class="ft-trash-2"></i> Edit</a>
                                                            <a href="{{route('delete-contact-title' ,  encrypt($contactTitle->id))}}" class="dropdown-item" title="Danger! this action will delete the record from database">
