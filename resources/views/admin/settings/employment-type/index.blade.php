            ...
            <div class="breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper mr-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Employment Types</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                <p class="card-text"><a href="{{route('create-view.employment-type')}}"
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        @foreach($employmentTypes as $employmentType)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($employmentType->status === 'active')
                                                        <span style="color:green"> {{$employmentType->status}}</span>
                                                    @else
                                                        <span style="color:blue"> {{$employmentType->status}}</span>
                                                    @endif

                                                </td>
                                                <td>{{$employmentType->created_at->diffForHumans()}}</td>
                                                <td>
                                                    <span class="dropdown">
                                                    ...
                                                    @if($employmentType->status === 'active')
                                                            <a href="{{route('inactive.employment-type' , encrypt($employmentType->id))}}" class="dropdown-item" title="click to make inactive the active value">
                                                                <i class="ft-plus-circle primary"></i> Inactive</a>
                                                    @else
                                                            <a href="{{route('active.employment-type' ,  encrypt($employmentType->id))}}" class="dropdown-item" title="click to make active the inactive value">
                                                                <i class="ft-plus-circle primary"></i> Active</a>
                                                    @endif
                                                            <a href="{{route('update.employment-type' ,  encrypt($employmentType->id))}}" class="dropdown-item" title="Edit the value">
                                                                <i class="ft-trash-2"></i> Edit</a>
                                                            <a href="{{route('delete.employment-type' ,  encrypt($employmentType->id))}}" class="dropdown-item" title="Danger! this action will delete the record from database">
