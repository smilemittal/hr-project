            ...
            <div class="breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper mr-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Update Document Type</a>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="card-body card-dashboard">
                                <div class="col-xl-4 col-lg-6 col-md-12">
                                    ...
                                    <div class="card-block">
                                        <div class="card-body">
                                            <form action="{{route('post-update-document-type' , encrypt($record->id))}}" method="post">
                                                @csrf
                                                <fieldset class="form-group">
                                                    <input type="text" name="document-type" value="{{$record->value}}"
                                                           placeholder="Write Document Type" class="form-control"
                                                           id="basicInput">
                                                    @if($errors->has('document-type'))
                                                        <div class="error" style="color:red">{{$errors->first('document-type')}}</div>
                                                    @endif
                                                </fieldset>
                                                <fieldset class="form-group">
                                                    <button type="submit" class="btn btn-success">Submit</button>
                                                    <a href="{{route('document-type-index')}}" class="btn btn-primary">View All</a>
                                                </fieldset>
                                            </form>
                                        </div>
                                    </div>
