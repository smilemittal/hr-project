                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                <form action="{{route('post-data.office-shift')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                             <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="shift_name" value="{{old('shift_name')}}">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="weekday" id="weekday" class="form-control border-primary">
                                                            ...
                                                            @foreach($weekdays as $day)
                                                                <option value="{{$day}}" @if($day == old('weekday'))selected @endif>{{$day}}</option>
                                                            @endforeach
                                                        </select>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary timepicker1" name="from" value="{{old('from')}}">
                                                        @if($errors->has('from'))
                                                              {{ json_encode($errors) }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary timepicker2" name="to" value="{{old('to')}}">
                                                        @if($errors->has('to'))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary datepicker1" name="start_date" value="{{old('start_date')}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary datepicker2" name="end_date" value="{{old('end_date')}}">
