            ...
            <div class="breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper mr-1">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Update Employee</a>
                        </li>
                    </ol>
                </div>
            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" value="{{$record->first_name}}" name="firstname">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary" value="{{$record->last_name}}" name="lastname">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="title" value="{{$record->title}}">
                                                        @if($errors->has('title'))
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary" name="employee-id" value="{{$record->employee_id}}" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="user-name" value="{{$record->user_name}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="email" id="userinput2"
                                                               class="form-control border-primary" name="email" value="{{$record->email}}">
                                                        @if($errors->has('email'))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="company" value="{{$record->company}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary" name="location" value="{{$record->location}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="department" value="{{$record->department}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary" name="designation" value="{{$record->designation}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="date" id="userinput1"
                                                               ...
                                                               name="date-of-joining" value="{{$record->date_of_joining}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="date" id="userinput2"
                                                               class="form-control border-primary"
                                                               name="date-of-leaving" value="{{$record->date_of_leaving}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="role" value="{{$record->role}}">
                                                        @if($errors->has('role'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="gender" id="" class="form-control border-primary">
                                                            <option value="{{$record->gender}}">{{$record->relGender->value}}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="martial-status" id="" class="form-control border-primary">
                                                            <option value="{{$record->martial_status}}">{{$record->relMartialStatus->value}}</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary"
                                                               name="contact-number" value="{{$record->contact_number}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="status" value="{{$record->status}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary" name="office-shift" value="{{$record->office_shift}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="date" id="userinput1"
                                                               class="form-control border-primary" name="dob" value="{{$record->date_of_birth}}">
                                                        @if($errors->has('dob'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="country" id="" class="form-control border-primary">
                                                            <option value="{{$record->country}}">{{$record->relCountry->value}}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="city" id="" class="form-control border-primary">
                                                            <option value="{{$record->city}}">{{$record->relCity->value}}</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="state" id="" class="form-control border-primary">
                                                            <option value="{{$record->state}}">{{$record->relState->value}}</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput1"
                                                               class="form-control border-primary" name="zip-code" value="{{$record->zip_code}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" id="userinput2"
                                                               class="form-control border-primary" name="address" value="{{$record->address}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="file" id="userinput1"
                                                               class="form-control border-primary" name="profile-image" value="{{$record->profile_image}}">
                                                        @if($errors->has('profile-image'))
                                                            <div class="error" style="color:red">Profile image must be required.</div>
                                                        @endif
                                                        <img class="mt-2" src="{{asset('storage/app/emp-profile-pictures/'.$record->profile_picture)}}" alt="" width="150" height="150">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
